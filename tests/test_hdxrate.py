...
class TestHDXrate(object):
    ...
    def test_seq1(self):
        ...
        pH_read = 6.6
        temp = 279
        rates = k_int_from_sequence(self.seq1, temp, pH_read, reference='poly',
        ...
        pH_read = 7.0
        temp = 278
        rates = k_int_from_sequence(self.seq1, temp, pH_read, exchange_type='DH', reference='poly',
                                    ph_correction='englander', wildcard='X') * 60
        # Reference rates obtained from Englander group xls sheet
        ...
        pH_read = 7.0
        temp = 278
        rates = k_int_from_sequence(self.seq1, temp, pH_read, exchange_type='HH', reference='poly',
                                    ph_correction='englander', wildcard='X') * 60
        # Reference rates obtained from Englander group xls sheet
